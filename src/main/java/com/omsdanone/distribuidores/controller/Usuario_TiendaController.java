...
public class Usuario_TiendaController {
  ...
  @DeleteMapping("/usuario_tienda/{usuarioid}/{tiendaid}/{cadenaformatoid}/{usuarioidupd}/{codigo}")
  ...
  @PathVariable("usuarioidupd") Short usuarioidupd, @PathVariable("codigo") String codigo) {
    try {
